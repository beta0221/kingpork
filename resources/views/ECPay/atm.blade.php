...
*/
    ...
    try {
        ...
        $obj->HashKey     = '6HWkOeX5RsDZnDFn' ;                                           //測試用Hashkey，請自行帶入ECPay提供的HashKey
        $obj->HashIV      = 'Zfo3Ml2OQXRmnjha' ;                                           //測試用HashIV，請自行帶入ECPay提供的HashIV
        $obj->MerchantID  = '1044372';                                                     //測試用MerchantID，請自行帶入ECPay提供的MerchantID
