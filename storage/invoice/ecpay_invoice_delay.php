...
// 2.寫入基本介接參數
	...
	$ecpay_invoice->Invoice_Url 			= Ecpay_Invoice_Env::Invoice_Url . '/Invoice/DelayIssue';
...
// 3.寫入發票相關資訊
	...
	$ecpay_invoice->Send['DelayFlag'] = '2';
	$ecpay_invoice->Send['DelayDay'] = '0';
	$ecpay_invoice->Send['ECBankID'] = '';
	$ecpay_invoice->Send['Tsr'] = $data['RelateNumber'];
