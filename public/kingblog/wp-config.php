 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         'mrsWUHSB}:Kq9L=P=c4ZwKqSA]G&gF;&C!y[Q(guT5de5Lgf,aD  q{]9HLbN|gK');
define('SECURE_AUTH_KEY',  '!@Pd#5A1JTt~9&id|O$eb9EGk-f-pJZ^:RJ<ui1w@o|bWS+GB@H[aJ:yYm0U@g6B');
define('LOGGED_IN_KEY',    '7Ws@r+_YN:43,8y2i9s!89awaTUc;=0j6{?:|*?e7+7Oo]t3$M!mbfh786jOHZ c');
define('NONCE_KEY',        '&cdrNj]fjO2*[Rs/=r>fFWWIzE,482&`^&$ro;ucuw! @]766FYer}|O[.D08q+w');
define('AUTH_SALT',        'A:?{C/nqYB90ge;%ByoT[kM]u]6DFPflq:.r^*y]0!}W)d7zS#raJmzP*cE7*!;s');
define('SECURE_AUTH_SALT', 'ZMFi*$]8%$6F^e5@R?!2rA:Koi*P}XoAioXp$)|Diq^5iyHRZ[gW,L+,/MG$(!$j');
define('LOGGED_IN_SALT',   'qsfW8[+4NeZ3qkb3$pa*n}r?|]K<F%Ut(V.7`|+`xynxvAW04jy R}n~{y@N2-Qh');
define('NONCE_SALT',       'vgV3U]Mv{4B(@_E}ilm]mtqbEE)|LCu<:0WHMS^ZumC:61*cN=p*Ms~$xKxX fTt');
